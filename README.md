...
## Components
The documentation for running is included in the backend repository.
- backend: https://github.com/dobisovaviktoria/gc2b-backend 
- frontend: https://github.com/dobisovaviktoria/gc2b-frontend 
- website for additional information: https://conference-website-0d8d6f.gitlab.io/

## Disclaimer
This project was developed for British Columbia Institute of Technology (BCIT) in Canada. The project is under MIT licence and may be used by BCIT for further purposes. 
